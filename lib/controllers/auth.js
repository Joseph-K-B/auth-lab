...
module.exports = Router()
  .post('/signup', async (req, res, next) => {
    try{
      const savedUser = await UserService.createUser({ ...req.body, roleTitle: 'QUEEN' });
      console.log('AT AUTH CONTROLLER POST', savedUser);
      res.cookie('userId', savedUser.authToken(), {
        httpOnly: true,
